...
/********************* Touch *********************/
    ...
    esp_lcd_touch_config_t tp_cfg = {
        ...
        .flags = {
            .swap_xy = 0,
            /* Must match the *active* panel transform. lvgl_port_update_cb's
             * mirror_x=true is NOT applied at boot (only on rotation change),
             * so the framebuffer is unmirrored — touch must be too. Otherwise
             * left-side taps hit the right-hand wedge. */
            .mirror_x = 0,
            .mirror_y = 0,
        },
    };
