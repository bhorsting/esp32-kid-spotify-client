...
#if 0 /* Waveshare LCD bring-up self-test — paints R/G/B bit-plane bars */
...
int QSPI_Init(void){
  ...
  /* Do not call test_draw_bitmap() — it paints RGB bit-plane bars that stick
   * on screen if LVGL fails to start. */
  return 1;
}
